#ifndef __SYMPHONY_LOGACCOUNT_LOGIN_INFO_H__
#define __SYMPHONY_LOGACCOUNT_LOGIN_INFO_H__
...
class AccountLoginInfoDao;
class AccountLoginInfo {
friend class AccountLoginInfoDao;
public:
    typedef std::shared_ptr<AccountLoginInfo> ptr;
...
class AccountLoginInfoDao {
public:
    typedef std::shared_ptr<AccountLoginInfoDao> ptr;
    static int Update(AccountLoginInfo::ptr info, symphony::IDB::ptr conn);
    static int Insert(AccountLoginInfo::ptr info, symphony::IDB::ptr conn);
    static int InsertOrUpdate(AccountLoginInfo::ptr info, symphony::IDB::ptr conn);
    static int Delete(AccountLoginInfo::ptr info, symphony::IDB::ptr conn);
    static int Delete(symphony::IDB::ptr conn);
    static int QueryAll(std::vector<AccountLoginInfo::ptr>& results, symphony::IDB::ptr conn);
    static AccountLoginInfo::ptr Query(symphony::IDB::ptr conn);
...
#endif //__SYMPHONY_LOGACCOUNT_LOGIN_INFO_H__
