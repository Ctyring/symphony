 ...
 */
#ifndef __SYMPHONY_SOCKET_H__
#define __SYMPHONY_SOCKET_H__
...
class Socket : public std::enable_shared_from_this<Socket>, Noncopyable {
   public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(symphony::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(symphony::Address::ptr address);
...
class SSLSocket : public Socket {
   public:
    ...
    static SSLSocket::ptr CreateTCP(symphony::Address::ptr address);
