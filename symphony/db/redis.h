#ifndef __SYMPHONY_DB_REDIS_H__
#define __SYMPHONY_DB_REDIS_H__
...
class FoxRedis : public IRedis {
   public:
    ...
    FoxRedis(symphony::FoxThread* thr,
...
class FoxRedisCluster : public IRedis {
   public:
    ...
    FoxRedisCluster(symphony::FoxThread* thr,
                    const std::map<std::string, std::string>& conf);
    ~FoxRedisCluster();
...
typedef symphony::Singleton<RedisManager> RedisMgr;
