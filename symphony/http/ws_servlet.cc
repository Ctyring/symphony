...
int32_t FunctionWSServlet::onConnect(symphony::http::HttpRequest::ptr header,
...
int32_t FunctionWSServlet::onClose(symphony::http::HttpRequest::ptr header,
                                   symphony::http::WSSession::ptr session) {
    if (m_onClose) {
...
int32_t FunctionWSServlet::handle(symphony::http::HttpRequest::ptr header,
