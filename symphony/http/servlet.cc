...
int32_t FunctionServlet::handle(symphony::http::HttpRequest::ptr request,
...
ServletDispatch::ServletDispatch() : Servlet("ServletDispatch") {
    m_default.reset(new NotFoundServlet("symphony/1.0"));
}

int32_t ServletDispatch::handle(symphony::http::HttpRequest::ptr request,
                                symphony::http::HttpResponse::ptr response,
                                symphony::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(symphony::http::HttpRequest::ptr request,
                                symphony::http::HttpResponse::ptr response,
                                symphony::http::HttpSession::ptr session) {
    response->setStatus(symphony::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "symphony/1.0.0");
