#ifndef __SYMPHONY_DS_HASH_MAP2_H__
#define __SYMPHONY_DS_HASH_MAP2_H__
...
class HashMap {
   public:
    ...
    void swap(HashMap& oth) {
        symphony::RWMutex::WriteLock lock(m_mutex);
        symphony::RWMutex::WriteLock lock2(oth.m_mutex);
...
symphony::RWMutex HashMap<K, V, PosHash>::s_mutex[MAX_MUTEX];
