...
class LogicSvrManager : public std::map<INT32, LogicServerNode*> {
   ...
   public:
    ...
    BOOL RegisterLogicServer(INT32 nConnID,
                             INT32 nServerID,
                             INT32 nPort,
                             INT32 nHttpPort,
    ...
    BOOL UpdateLogicServerInfo(INT32 nServerID,
                               INT32 nMaxOnline,
                               INT32 nCurOnline,
                               INT32 nTotal,
                               INT32 nCacheNum,
    ...
    LogicServerNode* GetSuggestServer(BOOL bReview,
                                      INT32 nChannel,
                                      UINT32 dwIpaddr);
    ...
    std::queue<LogicServerNode*> m_ArrChangedNode;
