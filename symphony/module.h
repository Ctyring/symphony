#ifndef __SYMPHONY_MODULE_H__
#define __SYMPHONY_MODULE_H__
...
class Module {
   public:
    ...
    virtual bool onConnect(symphony::Stream::ptr stream);
    virtual bool onDisconnect(symphony::Stream::ptr stream);

    virtual bool onServerReady();
    virtual bool onServerUp();

    virtual bool handleRequest(symphony::Message::ptr req,
                               symphony::Message::ptr rsp,
                               symphony::Stream::ptr stream);
    virtual bool handleNotify(symphony::Message::ptr notify,
                              symphony::Stream::ptr stream);
...
class RockModule : public Module {
   public:
    ...
    virtual bool handleRockRequest(symphony::RockRequest::ptr request,
                                   ...
                                   symphony::RockStream::ptr stream) = 0;
...
typedef symphony::Singleton<ModuleManager> ModuleMgr;
