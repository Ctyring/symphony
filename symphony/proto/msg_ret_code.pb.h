...
#ifndef GOOGLE_PROTOBUF_INCLUDED_symphony_2fproto_2fmsg_5fret_5fcode_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_symphony_2fproto_2fmsg_5fret_5fcode_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_symphony_2fproto_2fmsg_5fret_5fcode_2eproto
...
struct TableStruct_symphony_2fproto_2fmsg_5fret_5fcode_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_symphony_2fproto_2fmsg_5fret_5fcode_2eproto;
PROTOBUF_NAMESPACE_OPEN
PROTOBUF_NAMESPACE_CLOSE
...
enum MessageRetCode : int {
  ...
  MessageRetCode_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  MessageRetCode_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
inline bool MessageRetCode_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, MessageRetCode* value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_symphony_2fproto_2fmsg_5fret_5fcode_2eproto
