...
bool SpliteString(std::string strSrc,
                  std::string strDelim,
...
bool ReplaceString(std::string& strSrc,
                   const std::string& pattern,
                   const std::string& newpat);

bool StringToVector(const char* pStrValue,
