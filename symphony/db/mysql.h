#ifndef __SYMPHONY_DB_MYSQL_H__
#define __SYMPHONY_DB_MYSQL_H__
...
class MySQL : public IDB, public std::enable_shared_from_this<MySQL> {
   ...
   public:
    ...
    symphony::IStmt::ptr prepare(const std::string& sql) override;
...
class MySQLManager {
   public:
    typedef symphony::Mutex MutexType;
...
typedef symphony::Singleton<MySQLManager> MySQLMgr;
