...
int main(int argc, char** argv) {
    ...
    //     db = m;
    //     std::cout << "create table: "
    //               << test::orm::UserInfoDao::CreateTableMySQL(db) <<
    //               std::endl;
    // }
    // for (int i = 0; i < 10; ++i) {
    ...
    //           << test::orm::UserInfoDao::QueryByStatus(us, 1, db) <<
    //           std::endl;
    // for (size_t i = 0; i < us.size(); ++i) {
    //     std::cout << "i=" << i << " - " << us[i]->toJsonString() <<
    //     std::endl; us[i]->setName(us[i]->getName() + "_new");
    ...
    // us.clear();
    // std::cout << "query_by_status: "
    //           << test::orm::UserInfoDao::QueryByStatus(us, 0, db) <<
    //           std::endl;
    // for (size_t i = 0; i < us.size(); ++i) {
    //     std::cout << "i=" << i << " - " << us[i]->toJsonString() <<
    //     std::endl;
