 ...
 */
#ifndef __SYMPHONY_HTTP_SERVLET_H__
#define __SYMPHONY_HTTP_SERVLET_H__
...
class Servlet {
   public:
    ...
    virtual int32_t handle(symphony::http::HttpRequest::ptr request,
                           ...
                           symphony::http::HttpSession::ptr session) = 0;
...
class FunctionServlet : public Servlet {
   public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t(symphony::http::HttpRequest::ptr request,
                                  symphony::http::HttpResponse::ptr response,
...
class ServletDispatch : public Servlet {
   public:
    ...
    /**
     * @brief 添加模糊匹配servlet
     * @param[in] uri uri 模糊匹配 /SYMPHONY_*
